    ...
    >
      <div className="container mx-auto flex flex-wrap justify-between items-center py-4" dir="ltr">
        <div className="flex items-center">
          ...
          <h1 className="text-2xl font-bold text-gray-800">SweetMoon</h1>
        </div>
        ...
        <ul className={`flex-col md:flex-row md:flex md:space-x-6 text-gray-600 ${menuOpen ? 'flex' : 'hidden'} md:flex`}>
          <li>
